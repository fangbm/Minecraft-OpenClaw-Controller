...
public class ModConfig {
    ...
    // WebSocket 配置
    public static final ForgeConfigSpec.IntValue WEBSOCKET_PORT;
    public static final ForgeConfigSpec.BooleanValue AUTO_START;
    
    // 输入配置
    public static final ForgeConfigSpec.DoubleValue MOUSE_SENSITIVITY;
